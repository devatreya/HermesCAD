...
- Screw-hole presets use approximate default clearance/head dimensions, and threaded-hole modeling uses approximate helical groove geometry rather than standards-verified thread definitions.
